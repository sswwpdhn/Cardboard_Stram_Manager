...
public class StreamManagerConfigurator : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        {
            // IMPORTANT: Ensure these variable names match the variables in your UnityPythonClient.cs script!
            // Based on your image, we are assigning the main camera, IP, Port, and Quality.
            ...
            pythonClientScript.quality = 50; // Adjust if your quality variable is a float (e.g., 50f)
